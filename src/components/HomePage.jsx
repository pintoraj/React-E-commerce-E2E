...
const landingPagesData = [
  ...
  {
    bgImage: heroImage1, // imported alias
  ...
  {
    bgImage: heroImage2, //imported alias
...
const HeroSection = (
  { data, onScroll, isVisible }, // can be reused for more landing pages, planning to add 2 more landing pages...Ashwanth nd Dhanush suggestions.
) => (
  <section
  ...
  >
    ...
    >
      <ChevronDown //just a luicie react UI component guys
        size={28}
...
const HomePage = () => {
  ...
  // section ref should be declared prior as null, such that they can be assigned later for ref-references
